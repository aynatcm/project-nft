@extends('home')
@section('show-item')
    <div class="bg-[#0D0D11] flex pl-[216px] pr-[216px] pt-[80px] gap-x-[60px]">
        <div class="w-[60%] h-[767px] rounded-2xl">
            <img src="{{asset('uploads').'/'.$item->img_item}}" alt="image of item" class="rounded-2xl">
        </div>
        <div class="w-[40%] text-white">
            <h4 class="font-bold text-4xl text-white">{{$item->title}}</h4>

            <div class="flex gap-x-[12px] pt-[12px] justify-between">
                <div class="flex gap-x-[12px]">
                    <span
                        class="bg-[#343444] pl-[14px] pr-[14px] pt-[7px] pb-[7px] flex items-center justify-center gap-x-[6px] w-[75px] rounded-2xl">
...
<path fill-rule="evenodd" clip-rule="evenodd"
      d="M1.2558 6.00006C2.74381 9.06172 5.25023 10.882 7.99985 10.8828C10.7495 10.882 13.2559 9.06172 14.7439 6.00006C13.2559 2.93915 10.7495 1.11884 7.99985 1.1181C5.25103 1.11884 2.74381 2.93915 1.2558 6.00006V6.00006ZM8.00146 12.0003H7.99826H7.99746C4.68864 11.9981 1.71741 9.838 0.0486004 6.22049C-0.0162001 6.07967 -0.0162001 5.92022 0.0486004 5.77939C1.71741 2.16262 4.68944 0.00255002 7.99746 0.000314692C7.99906 -0.000430418 7.99906 -0.000430418 7.99986 0.000314692C8.00146 -0.000430418 8.00146 -0.000430418 8.00226 0.000314692C11.3111 0.00255002 14.2823 2.16262 15.9511 5.77939C16.0167 5.92022 16.0167 6.07967 15.9511 6.22049C14.2831 9.838 11.3111 11.9981 8.00226 12.0003H8.00146Z"
      fill="white"/>
</g>
</svg>
                 225
                ...
                <div class="flex gap-x-[12px]">
                    <span
                        class="bg-[#343444] p-4 flex items-center justify-center w-[50px] rounded-[50%]">
            ...
            <div class="bg-[#343444] mt-[24px] pt-[12px] pb-[12px] w-[295px] rounded-2xl">
                <div class="flex gap-x-[12px] items-center">
                    <div>
                        <img src="{{asset('img/avatar.png')}}" alt="image of a user" class="w-[44px] pl-[12px]">
                    </div>
                    <div>
                        <span class="block text-[#8A8AA0] text-sm font-normal">Created By</span>
                        <span class="block font-bold text-white text-[15px]">{{$item->user->name}}</span>
                    </div>
            ...
            <div
                ...
                <div>
                    ...
                    <span class="font-normal text-[13px]">ETH = {{$item->price*1736.18}}</span>
                    </span>
                </div>
            </div>
