    ...
    <div class="bg-[#7A798A] w-[290px] h-[283px] rounded-[20px] relative group block duration-300 ease-in-out">
        ...
        <div
            ...
            <img src="{{asset('img/avatar.png')}}" alt=""
                 class="w-full h-full rounded-3xl object-cover z-10  {{request()->routeIs('home','dashboard','show') ? 'hidden' : 'block'}}"
                 id="image-preview">
        </div>
        ...
        <div class="flex gap-x-[95px] items-center">
            ...
            @unless(request()->is('create'))
                <span
                    ...
                    <svg width="16" height="14" viewBox="0 0 16 14" fill="white" xmlns="http://www.w3.org/2000/svg" class="like_img">
<path
